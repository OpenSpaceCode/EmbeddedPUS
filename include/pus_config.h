...
/** @brief Maximum HK/diagnostic structures per ST[03] context. Override with
 * -DPUS_SERVICE_3_MAX_STRUCTURES=N. */
#ifndef PUS_SERVICE_3_MAX_STRUCTURES
#    define PUS_SERVICE_3_MAX_STRUCTURES 8u
#endif

/** @brief Maximum registered parameters per ST[20] context. Override with
 * -DPUS_SERVICE_20_MAX_PARAMS=N. */
